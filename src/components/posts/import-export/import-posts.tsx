...
import { FileUp, AlertCircle, CheckCircle, FileText } from "lucide-react"
...
export function ImportPosts() {
  ...
  const [importStage, setImportStage] = useState<"initial" | "preview" | "importing" | "complete" | "error">("initial")
            ...
            {importSource === "file" ? (
              <div className="space-y-4">
                <div className="flex flex-col items-center justify-center border-2 border-dashed rounded-md p-8">
                  ...
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">Supports JSON, CSV, and Markdown files</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setImportOptions({ ...importOptions, preserveDates: checked === true })
                        }
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setImportOptions({ ...importOptions, importAsDrafts: checked === true })
                        }
                      />
              ...
              <div className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    You&amp;apos;ll need to authorize Highlighter to access your {importSource} account.
                  </AlertDescription>
                </Alert>
