...
import { MoreHorizontal, ChevronDown, ChevronUp, Plus } from "lucide-react"
...
export function OutgoingRecommendations({ onAddRecommendation }: OutgoingRecommendationsProps) {
  ...
  const sortedRecommendations = [...mockOutgoingRecommendations].sort((a, b) => {
    if (sortBy === "name") {
      ...
      return sortDirection === "asc" ? a.subscribersSent - b.subscribersSent : b.subscribersSent - a.subscribersSent
    }
  })
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>
                <Button variant="ghost" className="p-0 font-medium" onClick={() => handleSort("subscribers")}>
                  Subscribers sent
                  {sortBy === "subscribers" && (
                    <span className="ml-2">
                      {sortDirection === "asc" ? (
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem className="text-destructive">Remove recommendation</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </TableCell>
              </TableRow>
