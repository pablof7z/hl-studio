                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                                ...
                                <FormDescription>
                                    Allow readers to subscribe to your publication for a fee.
                                </FormDescription>
                            </div>
                            <FormControl>
                                <Switch
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            The price for an annual subscription. Consider offering a discount compared
                                    ...
                                    <>
                                        ...
                                        <div className="rounded-lg border p-4">
                                            ...
                                            <p className="text-sm text-muted-foreground mb-4">
                                                For Bitcoin payments, you&amp;apos;ll need to set up a Lightning
                                                address.
                                            </p>
                                            <Button variant="outline" size="sm">
                                                Configure Lightning
