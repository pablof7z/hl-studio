                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Choose the subscription tier for these subscribers.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Enter one or more Nostr npubs, separated by commas.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                        ...
                                        <div className="space-y-1 leading-none">
                                            <FormLabel>Send welcome email</FormLabel>
                                            <FormDescription>
                                                Send a welcome email to subscribers who have an email address.
                                            </FormDescription>
                                        </div>
                                    </FormItem>
                                )}
