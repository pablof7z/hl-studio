...
import { Calendar, Clock, Edit, Mail, Twitter, Linkedin, Facebook } from "lucide-react"
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="flex items-center gap-1">
                          {post.distribution.email && <Mail className="h-3.5 w-3.5 text-muted-foreground" />}
                          {post.distribution.twitter && <Twitter className="h-3.5 w-3.5 text-muted-foreground" />}
                          {post.distribution.linkedin && <Linkedin className="h-3.5 w-3.5 text-muted-foreground" />}
                          {post.distribution.facebook && <Facebook className="h-3.5 w-3.5 text-muted-foreground" />}
                        </div>
                      </TooltipTrigger>
                      <TooltipContent>
