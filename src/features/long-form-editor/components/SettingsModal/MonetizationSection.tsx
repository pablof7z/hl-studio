...
export function MonetizationSection() {
    ...
    const isDuplicateUser = useCallback(
        (splits: { user: { pubkey: string } }[], pubkey: string) => splits.some((s) => s.user.pubkey === pubkey),
        []
    );
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-muted-foreground">
                    Add contributors to share zap revenue with. Each split is an integer; the share is calculated as
                    split/total.
                </p>
            </div>
            ...
            <div className="space-y-2">
                ...
                <Button onClick={() => setMentionModalOpen(true)} className="w-full mt-4" variant="outline">
